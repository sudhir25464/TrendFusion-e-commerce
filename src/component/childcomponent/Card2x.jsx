  ...
  return (
    ...
    <div class="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
      <div class="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
        ...
        <h1 class="mt-8 text-3xl font-bold tracking-tight text-black md:text-4xl lg:text-5xl">
...
Are you a visionary entrepreneur looking to expand and grow your business? Join our community of forward-thinking business leaders and take advantage of exclusive resources, innovative strategies, and unparalleled support. Together, we can achieve remarkable success and transform your business into a thriving
 enterprise. Partner with us today and start your journey towards extraordinary growth and success!"
        </p>
      ...
      <div class="flex lg:col-span-5 lg:-mr-8 xl:col-span-6 justify-center  justify-items-center md:mt-16 p-2 ">
        <img
          class="aspect-[3/2] bg-gray-50 object-cover lg:aspect-[4/3] lg:h-[500px] xl:aspect-[16/9]"
